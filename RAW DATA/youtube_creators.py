...
def get_video_data(channel_id, max_results=20):
    """Fetch video details from uploads playlist."""
...
def get_full_channel_info(channel_name):
    ...
    full_info = calculate_metrics(video_info, details)
    return full_info

# Example: Fetch data for one channel
channel_data = get_full_channel_info("Nimish Niwas")
